...
// import { RiMenu2Fill } from "react-icons/ri";
// import { FaUsers } from "react-icons/fa";
// import { MdLocalHospital } from "react-icons/md"; // Added icon for Health Schemes
// // Hooks
// import useTypedSelector from "../../hooks/useTypedSelector";
// // Auth
// import {
...
//   // Added Health Schemes in navigation for all roles
//   const userRoutes = [
//     { text: "Home", icon: IoHomeOutline, path: "/" },
//     {
//       text: "Appointments",
...
//       path: "/appointments",
//     },
//     { text: "Health Schemes", icon: MdLocalHospital, path: "/health-schemes" },
//     { text: "Apply Doctor", icon: FaUserDoctor, path: "/apply-doctor" },
//     { text: "Profile", icon: FaRegCircleUser, path: `/profile/${userId}` },
//   ];
...
import { RiMenu2Fill } from "react-icons/ri";
import { FaUsers } from "react-icons/fa";
import { MdLocalHospital } from "react-icons/md"; // Icon for Health Schemes & Govt Hospitals
// Hooks
import useTypedSelector from "../../hooks/useTypedSelector";
// Auth
import {
...
export default function Navbar({ children }: DashboardProps) {
  ...
  // Navigation routes including Govt Hospitals
  const userRoutes = [
    { text: "Home", icon: IoHomeOutline, path: "/" },
    {
      text: "Appointments",
